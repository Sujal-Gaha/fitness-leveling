...
import { ArrowRight, Award, Dumbbell, Flame, Heart, Lightbulb, Sparkles, Timer, TrendingUp, Zap } from 'lucide-react';
  ...
  const categories = [
    {
      ...
      prompts: [
        ...
        },
        {
          ...
          prompt:
            'Can you explain common fitness terms like sets, reps, HIIT, and progressive overload in simple terms?',
    ...
    },
    {
      ...
      prompts: [
        ...
        },
        {
          ...
          prompt:
            "I want to build muscle but don't have access to a gym. Create a home workout plan for muscle growth.",
          tags: ['Muscle Building', 'Strength', 'Home Workout'],
        },
        {
          title: 'Improve Endurance',
          prompt:
            'How can I improve my cardiovascular endurance over 4 weeks? I can run for about 10 minutes currently.',
